...
func TestNewEpiLayerClient_StaticToken(t *testing.T) {
	receivedToken := ""
	...
	client, err := NewEpiLayerClient(ClientConfig{
		Endpoint: server.URL,
...
func TestNewEpiLayerClient_TokenFile(t *testing.T) {
	receivedToken := ""
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		receivedToken = r.Header.Get("X-Auth-Token")
		w.Header().Set("Content-Type", "application/json")
...
func TestNewEpiLayerClient_TokenFileDynamicUpdate(t *testing.T) {
...
func TestNewEpiLayerClient_ErrorCases(t *testing.T) {
	tests := []struct {
		name        string
		config      ClientConfig
		expectError string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, err := NewEpiLayerClient(tt.config)
			if err == nil {
...
func TestNewEpiLayerClient_TokenFileErrors(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
	}))
	defer server.Close()
